...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/deepak-pathik-944b792a7/?trk=opento_sprofile_topcard",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@deepakpathik",
    icon: Github,
    url: "https://github.com/deepakpathik",
    color: "#ffffff",
